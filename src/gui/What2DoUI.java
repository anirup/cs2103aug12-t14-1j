 ...
 jPanel4.setBackground(new java.awt.Color(240, 232, 194));
	...
	private void displayDatabase(String message) {
		...
		*/
		...
		format(formattedUpcomingEvents, upcomingEvents, getMaximumLengths(upcomingEvents));
		format(formattedFloatingEvents, floatingEvents, getMaximumLengths(floatingEvents));
		format(formattedSearchResults, searchResults, getMaximumLengths(searchResults));
...
//				html4+=String.format("<br><p class=\"MsoNormal\"><b>%s&nbsp;<span style=\"color: rgb(0, 32, 96); \">%s</span>&nbsp;<span style=\"color: red; \">%s</span> &nbsp;<span style=\"color: rgb(155, 187, 89); \">%s</span> &nbsp;<span style=\"color: rgb(75, 172, 198); \">%s</span>&nbsp; <span style=\"color: rgb(79, 129, 189); \">%s</span>&nbsp; <span style=\"color: rgb(228, 108, 10); \">%s</span></span></b></p>", formattedSearchResults.get(i+1).get(0), formattedSearchResults.get(i+1).get(1), formattedSearchResults.get(i+1).get(2), formattedSearchResults.get(i+1).get(3), formattedSearchResults.get(i+1).get(5), formattedSearchResults.get(i+1).get(6), formattedSearchResults.get(i+1).get(7));
	...
	private void formatForSearch(ArrayList<ArrayList<String>> demo, ArrayList<String> events) {
		demo.get(0).set(0, "ID");
		demo.get(0).set(1, "Event Name");
		demo.get(0).set(2, "Details");
		demo.get(0).set(3, "Start");
	...
	private void format(ArrayList<ArrayList<String>> formattedDisplay, ArrayList<String> events, int[] maximumLengths) {
		...
		for (int i = 0; i < events.size(); i++) {
			...
			formattedDisplay.get(i+1).set(0, tempArray2[0] + getSpaces(maximumLengths[0] - tempArray2[0].length())+ "     ");
			formattedDisplay.get(i+1).set(1, tempArray2[1] + getSpaces(maximumLengths[1] - tempArray2[1].length())+ "     ");
			formattedDisplay.get(i+1).set(2, tempArray2[2] + getSpaces(maximumLengths[2] - tempArray2[2].length())+ "     ");
