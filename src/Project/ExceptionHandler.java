...
public class ExceptionHandler {
	...
	{	
		...
		listOfExceptions.add("Error: Command Not Found.");
		...
		listOfExceptions.add("Error: Could not perform Action - Please Check the Command entered.");
		listOfExceptions.add("Database corrupted - Formating Now.");
		listOfExceptions.add("Command performed Successfully.");
		listOfExceptions.add("Error: Illegal Command Entered.");
		listOfExceptions.add("Error: Illegal Content Entered.Please Check Your START/END/REMINDER Field Formats.");
		listOfExceptions.add("Error: Illegal Content Entered.Please Check Your Keywords.");
		listOfExceptions.add("Switched to Original View");
	}
